...
2.3  Set file paths in train_drl.py
..............................

Open train_drl.py and update the constants near the top:
...
Open train_drl.py and find the SAC model definition.
...
3. In train_drl.py, set EXPERT_JSON to point to this file:
  ...
  If expert_data.json is missing, train_drl.py now skips BC automatically
  and trains SAC from scratch.
...
Open evaluate_drl.py and update:
